...
APP_VERSION='3.10.2'
MARKER='CSM_RELEASE_IDENTITY_3_10_2'
DEV_VERSION='1.3.0'
TAX_VERSION='1.0.2'
DIFAL_VERSION='1.1.1'
BUILD_NAME='DIFAL ICMS ST 1.1.1 Aliquota visual + Fiscal + Fresh Core + Entender a Tributacao 1.0.2 + Motor Fiscal de Devolucao 1.3 + Importacao Modal V3.1 Fullscreen + Startup Maximizado'
OLD=r'(?:3\.7\.8|3\.8\.0|3\.8\.1|3\.9\.0|3\.9\.1|3\.9\.2|3\.9\.3|3\.9\.4|3\.9\.5|3\.9\.6|3\.10\.0|3\.10\.1)(?:\.\d+)?'
...
def main():
    ...
    if t.count(expected)<2:raise SystemExit('Modal Sobre nao esta fixado em 3.10.2')
    ...
    for tok in (MARKER,'CSM_DIFAL_ST_MODULE_V1','CSM_DIFAL_ST_DISPLAY_3102','Resumo por alíquota','renderFiscalPanel','CSM_TAX_ENGINE_V1','CSM_TAX_EXPLAINER_UI_V1','CSM_TAX_EXPLAINER_ENTRYPOINT_V2','CSM_DEVOLUTION_ENTRYPOINT_V4','CSM_FOLDER_IMPORT_PROGRESS_V3'):
