...
APP_VERSION='3.11.1'
MARKER='CSM_RELEASE_IDENTITY_3_11_1'
DEV_VERSION='1.3.0'
TAX_VERSION='1.0.2'
DIFAL_VERSION='1.1.1'
BUILD_NAME='Consulta NF-e Nativa 3.11.1 Acionamento Resiliente + DIFAL ICMS ST 1.1.1 + Fresh Core + Entender a Tributacao 1.0.2 + Motor Fiscal de Devolucao 1.3 + Importacao Modal V3.1 Fullscreen + Startup Maximizado'
OLD=r'(?:3\.7\.8|3\.8\.0|3\.8\.1|3\.9\.0|3\.9\.1|3\.9\.2|3\.9\.3|3\.9\.4|3\.9\.5|3\.9\.6|3\.10\.0|3\.10\.1|3\.10\.2|3\.11\.0)(?:\.\d+)?'
