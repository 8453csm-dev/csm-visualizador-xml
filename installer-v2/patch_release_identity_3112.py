...
APP_VERSION='3.11.2'
MARKER='CSM_RELEASE_IDENTITY_3_11_2'
DEV_VERSION='1.3.0'
TAX_VERSION='1.0.2'
DIFAL_VERSION='1.1.1'
BUILD_NAME='Consulta NF-e 3.11.2 XML Seguro + Abertura Automatica + PostInstall Fresh + DIFAL ICMS ST 1.1.1 + Entender a Tributacao 1.0.2 + Motor Fiscal de Devolucao 1.3 + Importacao Modal V3.1 Fullscreen'
OLD=r'(?:3\.7\.8|3\.8\.0|3\.8\.1|3\.9\.0|3\.9\.1|3\.9\.2|3\.9\.3|3\.9\.4|3\.9\.5|3\.9\.6|3\.10\.0|3\.10\.1|3\.10\.2|3\.11\.0|3\.11\.1)(?:\.\d+)?'
...
def main():
    ...
    info={
      ...
      'native_key_lookup_action_fallback':'3.11.1','native_key_lookup_xml_only':True,'native_key_lookup_blocks_spreadsheets':True,
      'native_key_lookup_validates_access_key_in_xml':True,'native_key_lookup_opens_via_broker':True,'postinstall_fresh_launcher':True,
    ...
    for tok in (MARKER,'CSM_NATIVE_KEY_LOOKUP_V1','CSM_NATIVE_LOOKUP_ACTION_3111','submitLookup','Consultar NF-e pela chave','CSM_DIFAL_ST_MODULE_V1','CSM_DIFAL_ST_DISPLAY_3102','renderFiscalPanel','CSM_TAX_ENGINE_V1','CSM_TAX_EXPLAINER_UI_V1','CSM_TAX_EXPLAINER_ENTRYPOINT_V2','CSM_DEVOLUTION_ENTRYPOINT_V4','CSM_FOLDER_IMPORT_PROGRESS_V3'):
