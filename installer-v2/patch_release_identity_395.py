...
APP_VERSION='3.9.5';MARKER='CSM_RELEASE_IDENTITY_3_9_5';DEV_VERSION='1.3.0';TAX_VERSION='1.0.2';BUILD_NAME='Entender a Tributacao 1.0.2 + Motor Fiscal de Devolucao 1.3 + Importacao Modal V3 + Startup Maximizado'
OLD=r'(?:3\.7\.8|3\.8\.0|3\.8\.1|3\.9\.0|3\.9\.1|3\.9\.2|3\.9\.3|3\.9\.4)(?:\.\d+)?'
